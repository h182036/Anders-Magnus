...
public class TekstGrensesnitt {
    ...
    public CD lesCD(){
        System.out.println("IDen til CD: ");
    ...
    public void skrivUtCdDelstrengTit(CDarkivADT cda, String delstreng){
    ...
    public void skrivUtArtist(CDarkivADT cda, String delstreng){
    ...
    public void skrivUtStats(CDarkivADT cda){
